    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('banner_img', models.ImageField(max_length=256, upload_to='%Y%m/sight/', verbose_name='详情大图')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entry_way', models.SmallIntegerField(choices=[(0, '短信换票入园'), (1, '凭验证码入园')], default=0, verbose_name='入园方式')),
