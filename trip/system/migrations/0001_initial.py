# Generated by Django 3.0.9 on 2025-07-02 09:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('object_id', models.IntegerField(verbose_name='关联模型ID')),
                ('content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType')),
                ('user', models.ForeignKey(null=True, on_delete=models.SET(None), related_name='upload_images', to=settings.AUTH_USER_MODEL, verbose_name='上传用户')),
            ],
            options={
